...
document.getElementById('header').innerHTML = `<h1 style="margin: 0px;"><img src="//uploads.scratch.mit.edu/users/avatars/61820378.png" alt='S0G' width="32" height="32" id="logo"> Hey there<span style="font-style: italic;">!</span></h1><div class="nav"><a href="/"><button type="button">Home</button></a><a href="/blog"><button type="button">Blog</button></a><a href="/alts"><button type="button">Alts</button></a><a href="/extras"><button type="button">Extras</button></a>${mainSiteBu}<button type="button" onclick="lightSwitch()">Light Switch</button></div>`;
